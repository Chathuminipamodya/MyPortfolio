    ...
    >
      ...
      >
        <span className="font-bold">
          Hello, I'm{" "}
          <TypingLoop text={"Chathumini"} speed={400}/>.
        </span>
        <br />
        <span className="font-bold">Full-stack developer</span> graduated from{" "}
<span className="font-bold">UoM Faculty of IT</span>. I enjoy building{" "}
<span className="italic">web, mobile apps & AI/ML solutions</span>.
      </motion.h1>
